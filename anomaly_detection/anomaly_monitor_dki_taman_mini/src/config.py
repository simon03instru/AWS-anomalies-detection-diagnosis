...
class Config:
    ...
    MQTT_PORT = 1883
    MQTT_TOPIC = "station/aws_dki_taman_mini"
    MQTT_QOS = 1
    MQTT_CLIENT_ID = "weather_anomaly_monitor_dki_taman_mini"
    ...
    MODEL_CONFIG = {
        ...
        'num_epochs': 10,
        'k': 0.1,
        'model_save_path': os.path.join(BASE_DIR, 'checkpoints'),
        'anomaly_ratio': 0.1
    }
