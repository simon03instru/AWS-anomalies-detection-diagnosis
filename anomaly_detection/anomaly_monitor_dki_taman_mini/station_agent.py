...
class WeatherAnomalyAgent:
    ...
    def __init__(
        ...
        if self.thought_logger:
            self.thought_logger.log_step("INITIALIZATION", "Initializing Weather Anomaly Agent DKI Taman Mini...")
    ...
    async def initialize(self):
        ...
        try:
            ...
            if self.thought_logger:
                self.thought_logger.log_step("INITIALIZATION", "Agent DKI Taman Mini initialization complete")
